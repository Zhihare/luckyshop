...
<Container>
      <div className={cn('mt-10 mb-14',className)}>
              ...
              <p className="text-gray-500 text-sm">
                  ...
                  забов'язується зберігати конфіденційність Ваших персональних даних,
              ...
              <Title size="sm" className='mt-10 mb-5' text="Конфіденційність даних" /> 
                <ul className="text-gray-500 text-sm space-y-5 ">
                    <li>Ми збираємо лише необхідну інформацію про клієнтів для обробки замовлень та забезпечення високоякісного обслуговування. Ваші персональні дані, такі як ім'я, адреса електронної пошти, адреса доставки, телефон та інші, будуть використовуватися виключно для забезпечення доставки товарів та обробки замовлень.</li>
                    <li>Ми не передаємо, не продаємо та не обмінюємо Ваші персональні дані третім особам, крім випадків, коли це необхідно для виконання зобов'язань, передбачених законом або на вимогу державних органів у відповідності з законодавством.</li>
                </ul>
        ...
        <ul className="text-gray-500 text-sm space-y-5 mb-5">
          ...
          <li>Якщо у Вас є запитання або пропозиції щодо нашої політики конфіденційності, будь ласка, зв'яжіться з нами за допомогою контактної інформації, наведеної на нашому сайті.</li>
